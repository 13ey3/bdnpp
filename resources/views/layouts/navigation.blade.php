    ...
    @auth
        <li class="nav-item">
            <a class="nav-link" href="{{ route('home') }}">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('coreui.svg#cil-speedometer') }}"></use>
                </svg>
                {{ __('Home') }}
            </a>
        </li>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle">
            ...
            <ul class="nav-group-items">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('resource') }}" target="_top">
                        <svg class="nav-icon">
                            <use xlink:href="{{ asset('coreui.svg#cil-list-rich') }}"></use>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('roles.index') }}">
                        <svg class="nav-icon">
                            <use xlink:href="{{ asset('coreui.svg#cil-group') }}"></use>
                        </svg>
                        {{ __('Roles') }}
                    </a>
                </li>
